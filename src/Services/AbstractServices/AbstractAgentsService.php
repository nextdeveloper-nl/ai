...
/**
 * This class is responsible from managing the data for Agents
 *
 * Class AgentsService.
 *
...
class AbstractAgentsService
{
    public static function get(AgentsQueryFilter $filter = null, array $params = []) : Collection|LengthAwarePaginator
    {
        ...
        */
        if($filter == null) {
            $filter = new AgentsQueryFilter($request);
        }
     ...
     * @return mixed
     */
    public static function getByRef($ref) : ?Agents
    {
        return Agents::findByRef($ref);
    }
    ...
    {
        $object = Agents::where('uuid', $objectId)->first();

        $action = AvailableActions::where('name', $action)
            ->where('input', 'NextDeveloper\AI\Agents')
            ->first();
     ...
     * @return Agents|null
     */
    public static function getById($id) : ?Agents
    {
        return Agents::where('id', $id)->first();
    }
    ...
    {
        try {
            $obj = Agents::where('uuid', $uuid)->first();
     ...
     * @return Agents
     */
    public static function updateRaw(array $data) : ?Agents
    {
    ...
    {
        $model = Agents::where('uuid', $id)->first();
